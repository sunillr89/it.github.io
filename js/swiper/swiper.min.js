...
var Swiper = function() {
    ...
    var k = {
        ...
        updateActiveIndex: function(e) {
            ...
            Object.assign(t, {
                ...
                previousIndex: n,
                activeIndex: d
            }), t.initialized && L(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (a !== u && t.emit("realIndexChange"), t.emit("slideChange"))
        },
    ...
    const X = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = _.bind(e), e.onTouchMove = V.bind(e), e.onTouchEnd = N.bind(e), e.onDocumentTouchStart = R.bind(e), t.cssMode && (e.onScroll = $.bind(e)), e.onClick = B.bind(e), e.onLoad = H.bind(e), j(e, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    const f = o.direction && o.direction !== i.direction,
                        ...
                        v = i.loop;
                    f && s && e.changeDirection(), c(e.params, o);
                    ...
                    }), h && !g ? e.disable() : !h && g && e.enable(), e.currentBreakpoint = a, e.emit("_beforeBreakpoint", o), s && (m ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !v && w ? (e.loopCreate(t), e.updateSlides()) : v && !w && e.loopDestroy()), e.emit("breakpoint", o)
                },
    ...
    class K {
        constructor() {
            ...
            const d = c({}, Y, l);
            return o.params = c({}, d, U, t), o.originalParams = c({}, o.params), o.passedParams = c({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach((e => {
